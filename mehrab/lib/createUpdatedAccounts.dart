...
//Sending sms with creditials
  ...
  void createOneAcc(Map<String, Object> Data, String Password, String text) {
    ...
    sending_SMS(
        //Sending SMS with credentials
        'تم تأكيد التحاقك بتطبيق محراب, نرجو استخدام رقم الهوية الوطنية وكلمة المرور المرفقة $Password للدخول إلى التطبيق, مع العلم أنه يجب عليك تغيير كلمة المرور عند دخولك, شكرًا لاستخدامك محراب.',
        [text]);
  }
}
